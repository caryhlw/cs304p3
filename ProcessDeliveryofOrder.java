...
public class ProcessDeliveryofOrder extends JDialog {
	...
	public static void main(String[] args) {
		try {
			ProcessDeliveryofOrder dialog = new ProcessDeliveryofOrder();
	...
	public ProcessDeliveryofOrder() {
		...
		contentPanel.setLayout(null);
		{
			...
			lblPleaseEnterUpc.setBounds(201, 121, 313, 50);
		...
		{
			JLabel lblProcessDeliveryOf = new JLabel("Process Delivery of Order");
			lblProcessDeliveryOf.setBounds(254, 30, 225, 14);
			contentPanel.add(lblProcessDeliveryOf);
		}
		{
