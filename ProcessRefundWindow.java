...
public class ProcessRefundWindow extends JDialog {
	...
	public static void main(String[] args) {
		try {
			ProcessRefundWindow dialog = new ProcessRefundWindow();
	...
	public ProcessRefundWindow() {
		...
		{
			JLabel lblProcessShipment = new JLabel("Process Refund");
